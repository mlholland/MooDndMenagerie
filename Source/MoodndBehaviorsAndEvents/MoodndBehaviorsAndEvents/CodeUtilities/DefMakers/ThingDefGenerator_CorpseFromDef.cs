...
/* A modified copy of the original THingDefGenerator_Corpse that's built into Rimworld. 
 * This variant only makes 1 corpse at a time based on an inputted animal def.
 * This is needed for in-code generator animals, as rerunning the entire vanilla 
 * corpse generation causes problems.
 */
namespace MoodndBehaviorsAndEvents
{
    public static class ThingDefGenerator_CorpseFromDef
    {
        ...
        [DebuggerHidden]
        public static ThingDef ImpliedCorpseDefFromAnimalDef(ThingDef raceDef )
        {
            ...
            d.SetStatBaseValue(StatDefOf.MarketValue, CalculateMarketValue(raceDef));
